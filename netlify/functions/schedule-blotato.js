// One-time Netlify function — call this ONCE to schedule all 30 days of IsItGoneDown
// posts in Blotato at 9 AM UTC per day (April 7 – May 6 2026).
// After running, all posts will appear in the Blotato dashboard for review/editing.
...
exports.handler = async (event) => {
  ...
  if (confirm !== 'yes') {
    return {
      statusCode: 400,
      body: JSON.stringify({ error: 'Add ?confirm=yes to run this. WARNING: this schedules all 30 days of posts in Blotato.' }),
    };
  }
